...
<div class="carousel1">
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-item active">
            <img src="/img/tattoo1.jpg" class="d-block w-100" alt="tt1">
        </div>
        <div class="carousel-item">
            <img src="/img/tattoo2.jpeg" class="d-block w-100" alt="tt2">
        </div>
        <div class="carousel-item">
            <img src="/img/tattoo3.jpg" class="d-block w-100" alt="tt3">
        </div>
        </div>
        ...
        <span class="visually-hidden">Suivabt</span>
        </button>
    </div>
</div>